...
We can wire the motor to the L293D chip just like with a normal motor. Pins 1 and 2 on the motor go to output 1 and 2 on the L293D. The input pins along with the enable should connect to the Arduino. In my example code and schematic, I have them connected to pins 3, 4, and 5. To test if the wiring is correct we should run my [https://github.com/VinsonOi/EV3MovementTest](movement test) code. 
